...
var AnnonceService = /** @class */ (function () {
    function AnnonceService(http) {
        this.http = http;
        this.annonce_url = "http://localhost:3000/annonces";
    }
    AnnonceService.prototype.getAnnonce = function () {
        return this.http.get(this.annonce_url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (res) { return res.json(); }));
    };
...
module.exports = "<div class=\"conteneur\">\n<!-- <div class=\"pos-f-t\">\n    <div class=\"collapse\" id=\"navbarToggleExternalContent\">\n        <div class=\"bg-dark p-4\">\n           <div class=\"input-group searchGrp pull-right\">\n        <input type=\"text\" [(ngModel)]=\"filtertext\" class=\"form-control\" placeholder=\"Rechercher par nom du produit...\">\n        </div>\n        </div>\n    </div>\n    <nav class=\"navbar navbar-dark bg-dark\">\n        <button class=\"navbar-toggler\" type=\"button\" data-toggle=\"collapse\" data-target=\"#navbarToggleExternalContent\" aria-controls=\"navbarToggleExternalContent\" aria-expanded=\"false\" aria-label=\"Toggle navigation\">\n            <span class=\"navbar-toggler-icon\"></span>\n        </button>\n    </nav>\n</div> -->\n\n<!-- Header -->\n<mat-toolbar color=\"primary\" align=\"center\">\n  <h1>Comparateur de prix</h1>\n</mat-toolbar>\n<!-- Header -->\n<!-- Expansion panel -->\n<mat-accordion>\n  <mat-expansion-panel>\n    <mat-expansion-panel-header>\n      <mat-panel-title align=\"center\">\n        Recherche & Filtres\n      </mat-panel-title>\n    </mat-expansion-panel-header>\n \n      <input matInput placeholder=\"Rechercher par nom du produit\"  [(ngModel)]=\"filtertext  \" >\n  \n  </mat-expansion-panel> \n</mat-accordion>\n<!-- Expansion panel -->\n.\n  <!--  -->\n\n  <div class=\"row \" >\n    <div class=\"col-md-3  myard\" *ngFor=\"let anonce of annonces | filter: filtertext \" >\n      <div class=\"card\" style=\"width: 18rem;\" >\n          <a href=\"{{anonce.urlProduct }}\"><img class=\"card-img-top\" src=\"{{anonce.imgProduct}}\" alt=\"Card image cap\"></a>\n          <div class=\"card-body\">\n            <h5 class=\"card-title\">{{anonce.libProduct | slice:0:15 | uppercase}}</h5>\n            <p class=\"card-text\">{{anonce.descProduct | slice:0:30}}...</p>\n            <a href=\"#\" class=\"badge badge-primary\">{{anonce.priceProduct }}</a>\n          </div>\n        </div>\n      </div>\n  </div>\n</div>"
...
/* harmony import */ var _annonce_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./annonce.service */ "./src/app/annonce.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.getService.getAnnonce().subscribe(function (responseAnnonce) { return _this.annonces = responseAnnonce; });
    };
    AppComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_annonce_service__WEBPACK_IMPORTED_MODULE_1__["AnnonceService"]])
    ], AppComponent);
    return AppComponent;
}());
...
/* harmony import */ var _annonce_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./annonce.service */ "./src/app/annonce.service.ts");
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            providers: [_annonce_service__WEBPACK_IMPORTED_MODULE_0__["AnnonceService"]],
...
module.exports = "<!DOCTYPE html>\n<html>\n<head>\n\t<title></title>\n</head>\n<body>\n\t<div class=\"container\">\n\t<h1>Comparateur de prix</h1>\n\t<p>\n\t\tNous regroupons tous les sites de vente en ligne\n\t</p>\n\t\t<div class=\"row\">\n        <div class=\"col-md-12\">\n            <form id=\"custom-search-form\" class=\"form-search form-horizontal pull-right\">\n                <div class=\"input-append span12\">\n                    <input type=\"text\" class=\"search-query\" name=\"searchQuery\" placeholder=\"Rechercher un produit \" >\n                </div>\n\t\t\t\t\t<button class=\"btn\" type=\"submit\" >Get Products</button>\n            </form>\n        </div>\n\t</div>\n\t</div>\n</body>\n</html>"
...
module.exports = __webpack_require__(/*! C:\Users\Babacar\Documents\TPANGULAR\comparer\src\main.ts */"./src/main.ts");
